#!/usr/bin/env node
/**
 * create-doc / execute.mjs — dispatch to tools/lib/create-doc.mjs.
 */
...
const { ACTIONS, FeishuError } = await import(
  'file://' + path.join(TOOLS_DIR, 'lib', 'create-doc.mjs').replace(/\\/g, '/')
);
...
async function main() {
  ...
  // create-doc has a single action; default it so callers don't have to repeat.
